		...
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<div class="footer-about-us">
					<h2>
						Doku<span>Learning</span>
					</h2>
					<p>DocuLearning es una forma f&aacute;cil de adquirir grandes
						conocimientos a trav&eacute;s de nuevos cursos desde tu hogar.
						Encuentra ofertas diarias de cursos con una tem&aacute;tica
						totalmente amplia y dispersa.</p>
			...
			<div class="col-md-3 col-sm-6">
				<div class="footer-menu">
					...
					<ul>
						<li><a href="#">Natalia Sanz Dig&oacute;n</a></li>
...
<div class="footer-bottom-area">
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<div class="copyright">
					<p>&copy; 2015 DokuLearning. Todos los Derechos Reservados.</p>
					<p>
						En colaboraci&oacute;n con</i> <a href="http://uc3m.es/Inicio"
							target="_blank">UC3M </a><i class="fa fa-heart"></i>
					</p>
				</div>
			</div>
